...
mejs.YouTubeApi = {
	...
	createIframe: function(settings) {
		...
		player = new YT.Player(settings.containerId, {
			...
			playerVars: {
				controls:0,wmode:'transparent',rel:0,showinfo:0,autohide:1,modestbranding:1
			},
			events: {
				'onReady': function() {
	...
	createFlash: function(settings) {
		...
		*/
		...
		var specialIEContainer,
			youtubeUrl = settings.scheme + 'www.youtube.com/apiplayer?enablejsapi=1&amp;playerapiid=' + settings.pluginId  + '&amp;version=3&amp;autoplay=0&amp;rel=0&amp;controls=0&amp;modestbranding=1&loop=0';
